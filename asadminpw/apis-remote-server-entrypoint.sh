...
echo "Enabling remote access to glassfish console..."
asadmin --user admin --passwordfile=/asadminpw/change-asadmin-pw.txt change-admin-password && \
    asadmin --user admin --passwordfile=/asadminpw/asadmin-pw.txt enable-secure-admin && \
